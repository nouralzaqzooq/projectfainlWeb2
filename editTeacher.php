...
<head>
    ...
    <title>تعديل بيانات المعلم - School Management System</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .form-group input:focus {
            border-color: #0d9488; /* تركيز بلون فيروزي مخصص لقسم المعلمين */
        }
        ...
        /* زر التحديث اللامع باللون الفيروزي البحري الساحر */
        .btn-update {
            background: linear-gradient(to left, #0f766e 0%, #0d9488 100%);
            color: white;
            border: none;
            padding: 11px 24px;
            border-radius: 6px;
            ...
            /* تأثير اللمعة الكريستالية الـ Glossy والظلال */
            box-shadow: inset 0 12px 12px rgba(255, 255, 255, 0.25), 0 4px 12px rgba(15, 118, 110, 0.2);
            transition: all 0.2s;
            display: inline-flex;
            align-items: center;
            gap: 8px;
        }
        .btn-update:hover { background: linear-gradient(to left, #0b5952 0%, #14b8a6 100%); }

        /* زر إلغاء التعديل والرجوع إلى جدول المعلمين */
        .btn-cancel {
            background: #f1f5f9;
            color: #475569;
            text-decoration: none;
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="page-title">
            <i class="fa-solid fa-chalkboard-user" style="color: #0d9488;"></i>
            <span>تعديل ملف المعلم الوظيفي</span>
        </div>

        <div class="card-form">
            <h3><i class="fa-solid fa-user-gear"></i> تعديل بيانات المعلم الحالي: (<?php echo $old_name; ?>)</h3>
            ...
            <form action="updateTeacher.php" method="post">
                ...
                <div class="form-flex">
                    ...
                    <div class="form-group">
                        <label>اسم المعلم الكامل (Teacher Name):</label>
                        <input type="text" name="teacher_name" value="<?php echo $teacher_name; ?>" required placeholder="أدخل اسم المعلم المعدل">
                    </div>

                    <div class="form-group">
                        <label>التخصص والمسار المهني (Specialization):</label>
                        <input type="text" name="specialization" value="<?php echo $specialization; ?>" required placeholder="مثال: رياضيات، علوم حاسب">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" value="<?php echo $email; ?>" required placeholder="example@school.com">
                    </div>
